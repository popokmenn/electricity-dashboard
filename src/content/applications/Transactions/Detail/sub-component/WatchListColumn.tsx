...
function WatchListColumn({ title, x = [], y = [], currentValue = 0 }: WatchListColumnProps) {
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {moment().diff(moment(x[0]), 'minute') < 60 ? `${moment().diff(moment(x[0]), 'minute')} minutes ago` : `${moment().diff(moment(x[0]), 'hour')} hours and ${moment().diff(moment(x[0]), 'minute') % 60} minutes ago`}
              </Typography>
            </Box>
          </Box>
          <Chart
